...
echo "Starting deployment of \${config.appName || 'application'} at $(date)"
...
if [ "\${config.framework}" = "flask" ] || [ "\${config.framework}" = "django" ] || [ "\${config.language}" = "python" ] || [ "\${config.appType}" = "python" ]; then
...
elif [ "\${config.framework}" = "express" ] || [ "\${config.framework}" = "node" ] || [ "\${config.appType}" = "node" ]; then
